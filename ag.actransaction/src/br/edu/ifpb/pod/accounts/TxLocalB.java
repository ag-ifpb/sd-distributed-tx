...
public class TxLocalB extends UnicastRemoteObject implements TxLocal {
	private Double oldState = null;
	private Account account;
	
	protected TxLocalB() throws RemoteException {}
	
	public TxLocalB(AccountB account) throws RemoteException {
